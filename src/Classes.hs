...
class CInN (x :: Nat) (σ :: LType sig) (g :: NCtx sig) where
--  inNCtx :: InN x σ g

instance CInN 'Z σ ('End σ) where
--  inNCtx = InEnd
instance CInN 'Z σ ('Cons ('Used σ) g) where
--  inNCtx = InHere nctx
instance (CInN x σ g) => CInN ('S x) σ ('Cons u g) where
--  inNCtx = InLater usg inNCtx

class CIn (x :: Nat) (σ :: LType sig) (g :: Ctx sig) where
--  inCtx :: In x σ g
...
class CAddCtx (x :: Nat) (σ :: LType sig) (g :: Ctx sig) (g' :: Ctx sig) | x σ g -> g', x g' -> σ g where
...
class CAddCtxN (x :: Nat) (σ :: LType sig) (g :: Ctx sig) (g' :: NCtx sig) (flag :: Bool) | x σ g -> g' flag, x g' flag -> σ g where
...
class CAddNCtxN (x :: Nat) (σ :: LType sig) (g :: NCtx sig) (g' :: NCtx sig) | x σ g -> g', x g' -> σ g where
...
class CAddNCtxFlag (x :: Nat) (σ :: LType sig) (g :: NCtx sig) (g' :: NCtx sig) (flag :: Bool) | x σ g -> g' flag, x g' flag -> σ g where
...
class CMergeU (u1 :: Usage sig) (u2 :: Usage sig) (u3 :: Usage sig)
      | u1 u2 -> u3, u1 u3 -> u2, u2 u3 -> u1 where
--  mergeU :: MergeU u1 u2 u3

instance CMergeU (Unused :: Usage sig) (Unused :: Usage sig) (Unused :: Usage sig)
--  mergeU = MergeUn
instance CMergeU ('Used σ) (Unused :: Usage sig) ('Used σ :: Usage sig) where
--  mergeU = MergeUL
instance CMergeU ('Unused :: Usage sig) ('Used σ) ('Used σ :: Usage sig) where
--  mergeU = MergeUR
...
instance CMergeNForward ('End σ) ('Cons 'Unused g2) ('Cons ('Used σ) g2) where
--  mergeNF = MergeEndL nctx
instance CMergeNForward ('Cons 'Unused g1) ('End σ) ('Cons ('Used σ) g1) where
...
--  divN = DivEndEnd
instance CDivN ('Cons ('Used σ) g) ('End σ) ('N ('Cons 'Unused g)) where
